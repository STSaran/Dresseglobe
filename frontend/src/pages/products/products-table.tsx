...
const ProductsTablesPage = () => {
  ...
  const [filters] = useState([{label: 'ProductName', title: 'name'},{label: 'Description', title: 'description'},

          {label: 'Price', title: 'price', number: 'true'},

    {label: 'Category', title: 'category', type: 'enum', options: ['Electronics','Clothing','Books','Home']},
  ]);
    const addFilter = () => {
        const newItem = {
            id: uniqueId(),
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/products/products-new'} color='info' label='New Item' />
