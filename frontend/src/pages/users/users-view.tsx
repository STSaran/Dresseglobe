      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Orders Buyer</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.orders_buyer && Array.isArray(users.orders_buyer) &&
                              users.orders_buyer.map((item: any) => (
                        ...
                        {!users?.orders_buyer?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
                ...
                <>
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.reviews_user && Array.isArray(users.reviews_user) &&
                        ...
                        {!users?.reviews_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
